...
#         __locations = __data_columns[3:]  # Locations start after sqft, bath, and bhk
...
def load_saved_artifacts():
    ...
    global __model
    # Construct the full path to banglore_home_prices_model.pickle
...
if __name__ == '__main__':
    ...
    print(get_estimated_price('kahalli', 1000, 2, 2))  # other location
